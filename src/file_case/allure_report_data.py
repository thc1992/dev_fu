...
import os
from src.file_case.get_all_files_path import get_all_files
...
class AllureFileClean:
    ...
    def get_testcases(cls) -> List:
        ...
        # 将所有数据都收集到files中
        files = []
        path= filepath +'/../../report/html/data/test-cases'
    ...
    def get_case_count(cls) -> "TestMetrics":
        ...
        try:
            ...
            file_name = filepath + '/../../report/html/widgets/summary.json'
