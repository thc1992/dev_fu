...
class Test_operation_confirm():
    def sets_up(self):
        ...
        self.headers = {
            ...
            "r-idempotent": r_idempotent(self.token, "orderConfirm")
        }
        self.pass_code = ('CONFIRMR01', 'CONFIRMR02', 'CONFIRMR03')
        self.data_dict = {'CONFIRMR01': '正常完成', 'CONFIRMR02': '维修成本过高，未进行服务', 'CONFIRMR03': '问题自行恢复正常，未进行服务',
                          'CONFIRMR04': '没有维修好，问题依然存在', 'CONFIRMR05': '工程师无法处理，需要重新安排', 'CONFIRMR06': '工程师未到店'}
        self.data_comfirm_dict = {confirm_requestOrderId01: '正常完成', confirm_requestOrderId02: '到店未服务',
                                  confirm_requestOrderId03: '电话指导完成', confirm_requestOrderId04: '误发起完成',
                                  confirm_requestOrderId05: '协商完成'}

    # 确认完成检查方法
    def confirm_sql_check(self, requestOrderId, remark, confirm_code):
        sql_check = sql_check_confirm + "(%s)" % str(requestOrderId)
        # print(sql_check)
