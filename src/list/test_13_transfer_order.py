...
class Test_transfer_order:
    ...
    def test_transfer_order(self):
        ...
        result = ('FSMROS03',  'FSMROS03006', 'FSMROS03006','FSMWOS02','APPLY')
        appointment = Read_sql_Data.Conte(transfer_order2)
        headers = {
            "r-auth": self.token,
        ...
        appointment2 = Read_sql_Data.Conte(transfer_result3 % appointment[0][0])
