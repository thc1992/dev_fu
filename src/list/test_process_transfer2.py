...
class Test_process_transfer:
    ...
    @allure.suite('转单拒绝流程')
    @allure.title("转单拒绝流程")  # 测试用例的标题
    @pytest.mark.one
    def test_process_transfer2(self):
        # 登录
        # lg = Test_login()
        # lg.test_regular_login()
        # 下单
        ...
        trans.test_transfer_order()
        #转单拒绝
        transfer_handle=Test_transfer_handle()
        transfer_handle.test_transfer_handle2()
